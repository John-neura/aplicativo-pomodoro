...
const imagenPlay = "./imagenes/play_arrow.png"; // Reemplaza con la ruta de tu imagen de play
const imagenPausa = "./imagenes/pause.png";
...
function iniciarOpausar() {
    if(idIntervalo){
        ...
        iconoIniciarPausar.src = imagenPlay;
        reiniciar();
        return;
    }
    audioPlay.play();
    idIntervalo = setInterval(cuentaRegresiva, 1000);
    iconoIniciarPausar.src = imagenPausa;
